function [img,gmap,snr,snr_pseudo,gmap_pseudo,noise_psf_pseudo] = ismrm_cartesian_SENSE(inp,csm,acc_factor,replicas,samp_mat,reg)
%
...
[unmix_sense, gmap]   = ismrm_calculate_sense_unmixing(acc_factor, csm,[],reg);
